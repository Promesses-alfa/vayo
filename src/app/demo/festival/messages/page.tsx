...
const conversations = [
  { id: 1, name: "Nightlife Agency", avatar: "NA", lastMessage: "DJ Storm confirmed for Main Stage", time: "10:30 AM", unread: 1 },
  { id: 2, name: "Production Team", avatar: "PT", lastMessage: "Stage setup on track", time: "Yesterday", unread: 0 },
  { id: 3, name: "Security", avatar: "SC", lastMessage: "Crowd control plan approved", time: "2 days ago", unread: 0 },
];

export default function FestivalMessagesPage() {
          ...
          <div className="flex-1 overflow-y-auto">
            {conversations.map((conv) => (
              ...
              >
                ...
                {conv.unread > 0 && (
                  <span className="w-5 h-5 rounded-full bg-emerald-500 flex items-center justify-center text-xs text-white">{conv.unread}</span>
                )}
              </div>
            ))}
          </div>
        ...
        <div className="flex-1 flex flex-col bg-[var(--vayo-black)]">
          ...
          <div className="p-4 border-t border-[var(--vayo-gray-800)] bg-[var(--vayo-gray-900)]">
            <div className="flex items-center gap-3">
              ...
              <button className="p-2.5 bg-emerald-500 hover:bg-emerald-600 rounded-xl text-white">
